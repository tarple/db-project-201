...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <table class="styleScheduleTable">
        <tr>
            <td>
                <asp:ListView ID="ListViewEmpSch" runat="server" DataSourceID="SqlDataSourceEmpSch"
                    InsertItemPosition="LastItem" DataKeyNames="schedule_id,employee_id">
                    <AlternatingItemTemplate>
                        <tr style="background-color: #FFF8DC;">
                            ...
                            <td>
                                <asp:Label ID="schedule_idLabel" runat="server" Text='<%# Eval("schedule_id") %>' />
                            </td>
                            <td>
                                <asp:Label ID="employee_idLabel" runat="server" Text='<%# Eval("employee_id") %>' />
                            </td>
                            <td>
                                <asp:Label ID="sch_dateLabel" runat="server" Text='<%# String.Format("{0:M/dd/yyyy}", Eval("sch_date")) %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column1CheckBox" runat="server" Checked='<%# Eval("column1") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column2CheckBox" runat="server" Checked='<%# Eval("column2") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column3CheckBox" runat="server" Checked='<%# Eval("column3") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column4CheckBox" runat="server" Checked='<%# Eval("column4") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column5CheckBox" runat="server" Checked='<%# Eval("column5") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column6CheckBox" runat="server" Checked='<%# Eval("column6") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column7CheckBox" runat="server" Checked='<%# Eval("column7") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column8CheckBox" runat="server" Checked='<%# Eval("column8") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column9CheckBox" runat="server" Checked='<%# Eval("column9") %>'
                                    Enabled="false" />
                            </td>
                            <td>
                                <asp:CheckBox ID="column10CheckBox" runat="server" Checked='<%# Eval("column10") %>'
                                    Enabled="false" />
                            </td>
                        </tr>
                    </AlternatingItemTemplate>
                    <EditItemTemplate>
                        <tr style="background-color: #008A8C; color: #FFFFFF;">
                            ...
                            <td>
                                <asp:Label ID="schedule_idLabel1" runat="server" Text='<%# Eval("schedule_id") %>' />
                            </td>
                            <td>
                                <asp:Label ID="employee_idLabel1" runat="server" Text='<%# Eval("employee_id") %>' />
                            </td>
                            <td>
                                <asp:TextBox ID="sch_dateTextBox" runat="server" Text='<%# String.Format("{0:M/dd/yyyy}", Eval("sch_date"))%>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column1CheckBox" runat="server" Checked='<%# Bind("column1") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column2CheckBox" runat="server" Checked='<%# Bind("column2") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column3CheckBox" runat="server" Checked='<%# Bind("column3") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column4CheckBox" runat="server" Checked='<%# Bind("column4") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column5CheckBox" runat="server" Checked='<%# Bind("column5") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column6CheckBox" runat="server" Checked='<%# Bind("column6") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column7CheckBox" runat="server" Checked='<%# Bind("column7") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column8CheckBox" runat="server" Checked='<%# Bind("column8") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column9CheckBox" runat="server" Checked='<%# Bind("column9") %>' />
                            </td>
                            <td>
                                <asp:CheckBox ID="column10CheckBox" runat="server" Checked='<%# Bind("column10") %>' />
                            </td>
                        </tr>
                    </EditItemTemplate>
                    <EmptyDataTemplate>
                                ...
                                <td runat="server">
                                    <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;
                                        ...
                                        <tr runat="server" style="background-color: #DCDCDC; color: #000000;">
                                            <th runat="server"></th>
                                            <th runat="server">Schedule ID</th>
                                            <th runat="server">Employee ID</th>
                                            <th runat="server">Schedule Date</th>
                                            <th runat="server">8:00 AM</th>
                                            <th runat="server">9:00 AM</th>
                                            <th runat="server">10:00 AM</th>
                                            <th runat="server">11:00 AM</th>
                                            <th runat="server">12:00 PM</th>
                                            <th runat="server">1:00 PM</th>
                                            <th runat="server">2:00 PM</th>
                                            <th runat="server">3:00 PM</th>
                                            <th runat="server">4:00 PM</th>
                                            <th runat="server">5:00 PM</th>
                                        </tr>
