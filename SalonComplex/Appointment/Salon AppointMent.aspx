<%@ Page Title="Salon Appointment" Language="C#" MasterPageFile="~/Master/Site.Master"
    AutoEventWireup="true" CodeBehind="Salon AppointMent.aspx.cs" Inherits="SalonComplex.Appointment.SalonAppointMent" %>
                ...
                <div boomtime="right" id="service_menu_edit" class="style13">
                    <div class="style14">
                        <dt style="width: 255px" class="style14">
                            <asp:DropDownList ID="SalonDropDownList" runat="server" ClientIDMode="Static" AutoPostBack="True"
                                OnSelectedIndexChanged="LoadServices">
            ...
            <div boomtime="right" id="hour_edit">
                ...
                <table class="appoint_td">
                    <tr>
                        ...
                        <td class="style28">
                            <p class="appoint_p">
                                <asp:Label ID="SalonDateLabel" runat="server" Style="font-size: medium; font-family: 'Segoe UI'"
                                    Text="Enter Appointment Date:" Width="242px" Height="21px"></asp:Label>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td class="style27">
                            <p class="appoint_p">
                                <asp:DropDownList ID="DropDownListSalonServices" runat="server" DataSourceID="SqlDataSourceDropListServices"
                                    DataTextField="employee_type" DataValueField="employee_type" Height="25px" Width="200px"
                                    Enabled="False">
                                </asp:DropDownList>
